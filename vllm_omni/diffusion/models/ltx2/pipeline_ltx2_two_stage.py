...
class LTX2TwoStagesPipeline(LTX2LoraLoaderMixin, LTXPipelineRuntime):
    """Legacy LTX2 two-stage compatibility entry."""
        ...
        *,
        ...
        try:
            if not self.distilled:
                ...
                self.load_lora_weights(lora_path, adapter_name="stage_2_distilled")
                stage2_lora_loaded = True
            ...
            stage2 = self.run_phase(
                ...
                timesteps=None,
                attention_kwargs=attention_kwargs,
                prompt_context=(stage1.forward_context.prompt_context if self.distilled else None),
            )
            return self.decode_phase(stage2)
        finally:
            if stage2_lora_loaded:
                self.unload_lora_weights("stage_2_distilled")
